...
public class SongShape extends Shape{
    ...
    public SongShape(int x, int y, int width, int height, Window win)
    {
        ...
        yHeard = new Shape(x - 45, y + (2 * BAR_WIDTH), 45, BAR_WIDTH, Color.YELLOW);
        gHeard = new Shape(x - 61, y + (3 * BAR_WIDTH), 61, BAR_WIDTH, Color.GREEN);
        
        pLiked = new Shape(x + 5, y, 40, BAR_WIDTH, Color.PINK);
        bLiked = new Shape(x + 5, y + BAR_WIDTH, 28, BAR_WIDTH, Color.BLUE);
        yLiked = new Shape(x + 5, y + (2 * BAR_WIDTH), 20, BAR_WIDTH, Color.YELLOW);
        gLiked = new Shape(x + 5, y + (3 * BAR_WIDTH), 14, BAR_WIDTH, Color.GREEN);
